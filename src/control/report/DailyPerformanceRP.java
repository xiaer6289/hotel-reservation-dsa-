...
public class DailyPerformanceRP {
    ...
    public void generateReport(
        ...
        String normalizedStaff =
                normalizeStaffFilter(staffFilter);
    ...
    private boolean matchesStaff(
        ...
        return getDisplayStaffId(task)
                .equalsIgnoreCase(
                        staffFilter);
    }

    private boolean matchesMinimumTime(
            TaskLogEntry task,
            long minimumMinutes) {

        return getTaskDurationMinutes(task)
                >= minimumMinutes;
    }
    ...
    private void printManagementSummary(
        ...
        System.out.printf(
                "Average Task Time    : %.2f minute(s)%n",
                averageTaskTime);
    ...
    private String normalizeStaffFilter(
            String value) {
