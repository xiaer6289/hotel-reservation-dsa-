...
public class HousekeepingUI {
    ...
    private String selectRoom() {
        ...
        String[][] rooms =
                controller.getRoomSelectionDisplayData();
    ...
    private String selectTask() {
        ...
        String[][] tasks =
                controller.getTaskSelectionDisplayData();
