...
public class WalkInRegistrationDao {
    ...
    private static final String LEGACY_FILE_NAME = "registration.dat";
    ...
    public WalkInRegistration[] retrieveFromFile() {
        ...
        if (!file.exists()) {
            File legacyFile = new File(LEGACY_FILE_NAME);
    ...
    public WalkInRegistration[] loadExisting() {
        WalkInRegistration[] registrations = retrieveFromFile();
